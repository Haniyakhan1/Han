...
print  """
\033[1;97m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE MR ANQ ~
\033[1;97m************************************************
...
jalan("\033[1;92m             | |  (_)   | |")             
jalan("\033[1;92m  _ __   __ _| | ___ ___| |_ __ _ _ __ Mr ANQ ZINDABAD✔ ") 
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:ANQ+HaNi
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mANQ+HaNi\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mANQ+HaNi\033[1;95m•◈•══════••◈•"
		try:
	...
	jalan('           \033[1;91m HANIYA KHAN AND AMIR NIAZ  start cloning Wait...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
...
cek = open("out/super_cp.txt", "a")
	...
	print "  \033[1;91m«---•◈•---Developed By ANQ+HaNi--•◈•---»" #Dev:ANQ+HaNi
